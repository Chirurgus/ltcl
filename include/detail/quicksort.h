...
template<class I>
void ltc::detail::partition(I begin, I end, I pivot)
{
	typedef typename ltc::iterator_traits<I>::value_type value_type;
...
template<class I>
void ltc::detail::quicksort_recurrsive(I begin, I end)
{
	for (;;) {
		if ((end - begin) <= 60) {//opimal on my machine
			insertsort(begin, end);
...
//than the stack version.
template<class I>
void ltc::detail::quicksort(I begin, I end)
{
	struct vec_s {
		I begin, end;
	};
...
#endif// !GURAD_LTCL_DETAIL_QUICKSORT_H
